...
public class SettingsSubScene {
    ...
    private VBox vbox;
    private HBox easy,medium,hard; // for game difficulty
    private HBox on, off; // for music play
    private static final int hboxSpacing = 150;
    private SettingsSubsceneButtons easyDifficultyButton, mediumDifficultyButton, hardDifficultyButton;
    private SettingsSubsceneButtons onButton, offButton; // music on off button
    private SettingsLabel easyLabel, mediumLabel, hardLabel, head1;
    private SettingsLabel onLabel, offLabel, head2; // music on off label
    private SettingsSubsceneButtons save;
    int temp_difficulty;
    int difficulty;
    boolean musicPlay;
